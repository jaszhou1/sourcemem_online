...
MINIMUM_SESSION_REST_HRS = 0.1 #20
WAIT_UNTIL_TOMORROW_HRS = 0.01 #10
...
def get_best_user_allocation():
    ...
    In this version, always return true.
    """
