function [ll, aic, P, pest_penalty] = orthosem_add_model(Pvar, Pfix, Sel, Data, badix)

% Four Factor model, where non-spatiotemporal things are additive
...
% ----------------------------------------------------------------------------
Ub= [ 8,   0,    8,   0,   1,    1,       4.5, 4.5,  1.0,  1.0,  1.0,    5,    5,     2.0,    1,   1, 1, 0.3,  0.2];
Lb= [ 0,   0,    0,   0,   0,    0,       0.1, 0.5,  0,    0,    0.4,      0,    0,     0,      0,  0, 0, 0,    0];
Pub=[ 7.5, 0,    7.5, 0,   0.9,  0.9,     4.0, 4.0,  0.99, 0.8,  0.9,    4.5,  4.5,   0.99,   0.9, 1, 1, 0.25, 0.15];
Plb=[ 0,   0,    0,   0,   0,    0,       0.7, 0.7,  0.01, 0.01, 0.5,   0.01, 0.01,  0.01,   0.01, 0, 0, 0.01, 0.01];
