function [ll, aic, P, pest_penalty] = three_component_model(Pvar, Pfix, Sel, Data, badix)
...
% This version adds a third component for uniform guessing from a
% zero-drift diffusion process
...
pest_penalty(1,:) = P;
% ----------------------------------------------------------------------------
%   [v1t, v2t,  v1i, v2i, eta_t, eta_i,   at,  ag,  gamma, beta, Ter, st]
% ----------------------------------------------------------------------------
Ub= [ 8,   0,    8,   0,   1,    1,       4.5, 4.5,  1.0,  1.0,   0.3,  0.2];
Lb= [ 0,   0,    0,   0,   0,    0,       0.1, 0.5,  0,    0,     0,    0];
Pub=[ 7.5, 0,    7.5, 0,   0.9,  0.9,     4.0, 4.0,  0.99, 0.8,   0.25, 0.15];
Plb=[ 0,   0,    0,   0,   0,    0,       0.7, 0.7,  0.01, 0.01,  0.01, 0.01];
...
for i = 1:length(Data)
    ...
    Gt =  (1-gamma-beta) * Gt_target + gamma * Gt_int + beta * Gt_guess;
