...
Lb= [ 0,   0,    0,   0,   0,    0,       0.1, 0.5,  0,    0,    0,      0,    0,     0,      0,   0,    0];
Pub=[ 7.5, 0,    7.5, 0,   0.9,  0.9,     4.0, 4.0,  0.99, 0.8,  0.9,    4.5,  4.5,   0.99,   0.9, 0.25, 0.15];
Plb=[ 0,   0,    0,   0,   0,    0,       0.7, 0.7,  0.01, 0.01, 0.01,   0.01, 0.01,  0.01,   0.01,0.01, 0.01];
...
spatiotemporal_similarities = ((1-rho)*temporal_similarities) + (rho*spatial_similarities);
