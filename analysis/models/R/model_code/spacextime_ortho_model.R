...
# chi: weight of orthographic vs spatiotemporal similarity
ortho_model <- function(params, data){
  ...
  intrusion_weights <- ((temporal_similarity^(1-rho)) * (spatial_similarity^rho))^(1-chi) * (orthographic_similarity ^ chi) 
...
simulate_ortho_model <- function(participant, data, pest){
