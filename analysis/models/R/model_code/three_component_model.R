## full_intrusion_model.R
##
## This is the full Bays et al. (2009) intrusion model with uniform mixture and intrusion components
## This is a working vectorised implementation


intrusion_model <- function(params, in_data){
  n_intrusions <- 9
  
  # Get parameters
  prec <- params[1] # Precision of Memory Distribution
  gamma <- params[2] # Proportion of Intrusions
  beta <- params[3] # Proportion of Guesses
...
sim_intrusion <- function(participant, this_prec, this_gamma, this_beta, this_data){
